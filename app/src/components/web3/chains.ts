...
const LOCAL: AddEthereumChainParameter["nativeCurrency"] = {
  name: "Hardhat",
  symbol: "ETH",
  decimals: 18,
};
...
export const MAINNET_CHAINS: ChainConfig = {
  0: {
    urls: ["https://localhost:8545"].filter(Boolean) as string[],
    name: "Local",
  },
  1: {
    urls: [
...
export const TESTNET_CHAINS: ChainConfig = {
  ...
  80001: {
    urls: [getInfuraUrlFor("polygon-mumbai")].filter((url) => url) as string[],
    name: "Polygon Mumbai",
    nativeCurrency: MATIC,

...
export interface Iotabots_abiInterface extends utils.Interface {
  functions: {
...
export interface Iotabots_abi extends BaseContract {
  contractName: "Iotabots_abi";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Iotabots_abiInterface;

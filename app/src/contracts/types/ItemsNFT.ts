...
export interface ItemsNFTInterface extends utils.Interface {
  functions: {
    "balanceOf(address,uint256)": FunctionFragment;
    "balanceOfBatch(address[],uint256[])": FunctionFragment;
    "createItem(uint8,uint256)": FunctionFragment;
...
export interface ItemsNFT extends BaseContract {
